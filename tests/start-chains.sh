...
docker run --name gravity_test_instance $PLATFORM_CMD --mount type=bind,source="$(pwd)"/,target=/root/go/src/gravity --cap-add=NET_ADMIN -p 9092:9092 -p 9093:9093 -p 26658:26658 -p 1317:1317 -p 8546:8546 -it gravity-base /bin/bash /root/go/src/gravity/tests/container-scripts/reload-code.sh $NODES $TEST_TYPE $ALCHEMY_ID
